...
public class HomeController {
	...
	@GetMapping("/ex03")
	public void ex03(Model model) throws IOException {
	...
	public String update(String name, int idx) throws IOException {
		fs.fileUpdate(name, idx);
		
		return "redirect:/ex03/";
	}
	
	@GetMapping("/file/delete/{idx}")
