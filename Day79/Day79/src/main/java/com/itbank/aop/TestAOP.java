...
public class TestAOP {
	...
	@Before("execution(* com.itbank.service.BoardService.*(com.itbank.beans.BoardVO))")
	public void change(JoinPoint jp) {
		//System.out.println(jp.getArgs()[0] instanceof BoardVO);
		
		BoardVO input = (BoardVO) jp.getArgs()[0];
		
		// input.setTitle(input.getTitle() + "AOP 개입");
		// - 매번 게시글 제목에 추가 되기 때문에 제거
